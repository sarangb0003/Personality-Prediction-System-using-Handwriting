...
def report():
    ...
    return("-------------------------------------------------------------------------------------------------")
    return("----------------------------SARANG BAGUL PERSONALITY PREDICTION SYSTEN------------------------------")
    return("\n")
...
def main():
    ...
    # Title
    st.title("Personality Prediction System By SARANG BAGUL")
...
get_ipython().system('jupyter nbconvert   --to script  Final_Sarang.ipynb')


# In[ ]:


get_ipython().system('streamlit run Final_Sarang.py')
